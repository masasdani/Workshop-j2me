...
//GEN-LINE:|7-commandAction|8|28-postAction
                ...
                double var1 = Double.parseDouble(angka.getString());
...
//GEN-LINE:|7-commandAction|10|22-postAction
    ...
    public Form getForm() {
        if (form == null) {//GEN-END:|14-getter|0|14-preInit
            ...
            form = new Form("form", new Item[] { getStringItem(), getAngka(), getAngka2(), getHasil() });//GEN-BEGIN:|14-getter|1|14-postInit
    ...
    //<editor-fold defaultstate="collapsed" desc=" Generated Getter: angka ">//GEN-BEGIN:|17-getter|0|17-preInit
    /**
     * Returns an initiliazed instance of angka component.
     * @return the initialized component instance
     */
    public TextField getAngka() {
        if (angka == null) {//GEN-END:|17-getter|0|17-preInit
            // write pre-init user code here
            angka = new TextField("Angka 1", null, 32, TextField.DECIMAL);//GEN-LINE:|17-getter|1|17-postInit
            // write post-init user code here
